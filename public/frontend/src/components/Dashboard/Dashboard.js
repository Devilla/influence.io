                        ...
                        <Col md={6}>
                            <Row>
                                ...
                                <Col lg={6} sm={6}>
                                   ...
                                   <Col lg={12} sm={12}>
                                     <StatsCard
                                        statsClass="card card-stats  eqheight"
                                        statsText="Unique Visitors"
                                        statsValue={this.state.UniqueVisitor}
                                    />
                                    </Col>
                                   </Row>
                                   <Row>
